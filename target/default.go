...
func targetDefaultYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "target/default.yaml", size: 425, mode: os.FileMode(420), modTime: time.Unix(1510273099, 0)}
