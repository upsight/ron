...
func makeDefaultYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "make/default.yaml", size: 3336, mode: os.FileMode(420), modTime: time.Unix(1487266313, 0)}
